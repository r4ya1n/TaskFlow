<template>
    <div class=" grid grid-cols-6
     ...
     hover:bg-bg3 cursor-pointer">
        ...
        <TaskStatusPill :status="task.status"></TaskStatusPill>
        <TaskExecutor :executor="task.executor"></TaskExecutor>
        <TaskPriorityPill :priority="task.priority"></TaskPriorityPill>
